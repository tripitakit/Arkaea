defmodule ArkeaWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use ArkeaWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      @endpoint ArkeaWeb.Endpoint

      use ArkeaWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import ArkeaWeb.ConnCase
    end
  end
